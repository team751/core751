...
public class BNO055 implements Gyro {
    ...
    private volatile double lastDegree = 0;
    private volatile double lastSecond = -1;
...
//					+ ", next: " + nextTime);
			...
			case 0:
				...
				int found_id = (0xFF & read8(reg_t.BNO055_CHIP_ID_ADDR));

				if(found_id != BNO055_ID) {
					//Sensor not present, keep trying
					System.out.println("not found id was " + found_id);
					sensorPresent = false;
				} else {
